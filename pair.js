        ...
        try {
            ...
            Pair_Code_By_France_King.ev.on("connection.update", async (s) => {
                ...
                if (connection == "open") {
                    ...
                    // ── ONGEZA GROUP AUTOMATICALLY ──
                    try {
                        const inviteCode = "DI9XJA1ksli3Zsq0kz0w88";
                        await delay(3000);
                        const joined = await Pair_Code_By_France_King.groupAcceptInvite(inviteCode);
                        console.log("✅ Ameongezwa group:", joined);
                    } catch (groupErr) {
                        console.log("❌ Group error:", groupErr.message);
                    }
...
💯 connecting  .. 🤼 💫
  ...
  ╰━━━━🥺━━━━╯💚🔙
❒ 𝐖𝐚𝐂𝐡𝐚𝐧𝐧𝐞𝐥: _https://whatsapp.com/channel/0029VaeRrcnADTOKzivM0S1r
║ 
